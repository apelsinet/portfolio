...
export default ({ style }) => (
    <svg
        ...
        x="0px"
        y="0px"
        viewBox="0 0 51.529 51.529"
        style={style}
    >
        <g>
            <path
                style={{ fill: '#ED8F20' }}
                d="M36.486,12.899l-5.089-0.419l1.884-4.746c0.308-0.775,0.696-1.499,1.139-2.177
            ...
            <g>
                <path
                    style={{ fill: '#ED8F20' }}
                    d="M27.765,11.529c0,0,4.25,0.7,5.4,3.6"
                />
                <path
                    style={{ fill: '#9B6026' }}
                    d="M33.165,16.13c-0.397,0-0.773-0.239-0.93-0.632c-0.925-2.331-4.599-2.976-4.635-2.982
            ...
            <g>
                <path
                    style={{ fill: '#ED8F20' }}
                    d="M28.365,14.529c1.037-1.14,2.345-2.025,3.787-2.567"
                />
                <path
                    style={{ fill: '#9B6026' }}
                    d="M28.364,15.529c-0.24,0-0.481-0.086-0.673-0.26c-0.408-0.372-0.438-1.004-0.066-1.413
            ...
            <path
                style={{ fill: '#659C35' }}
                d="M50.765,0.46l-5.089-0.419C40.301-0.401,35.27,2.722,33.281,7.734l-1.884,4.746l5.089,0.419
                c5.374,0.442,10.406-2.681,12.395-7.693L50.765,0.46z"
            />
            <path
                style={{ fill: '#88C057' }}
                d="M31.958,11.068l-0.561,1.413l0.718,0.059c6.258-6.111,13.059-8.117,13.803-8.164l0.035-0.559
