...
export default class Contact extends React.Component {
  render() {
    return (
      <div>
        <section>
					<svg xmlns="http://www.w3.org/2000/svg"  className="svg-contact" viewBox="0 0 537.5 551.4">
  <defs>
  ...
  <path fill="#C02942" d="M238.4 161h299v236h-299z" clipPath="url(#b)"/>
  <path fill="#6E302D" d="M292.6 361l-.2 36.6-162.6-1c-39 0-71-8.5-71-18.5 0-9.5 32-17.5 71.2-17.3l162.6.7z" clipPath="url(#b)"/>
  <path fill="#A44844" d="M292.6 359l-.2 36.4-162.6-1c-39-.2-71-8.5-71-18.5s32-18 71.2-18l162.6 1z" clipPath="url(#b)"/>
  <g clipPath="url(#b)">
    <path fill="#6E302D" d="M231.3 161c-25.4 4-40 31.4-40 55.8v141.8h103.3v-136c0-31.7-28-67-63.3-61.6z"/>
  </g>
  <path fill="#7B3633" d="M189.3 358.6l103.3 35.6v-35.6" clipPath="url(#b)"/>
  ...
  <path fill="#C02942" d="M322 97.7l-54 17.7 54 17.6" clipPath="url(#b)"/>
  <g clipPath="url(#b)">
  ...
  <path fill="#EAEBE1" d="M335.4 397h61.3v154.5h-61.3z" clipPath="url(#b)"/>
  <path fill="#D1D1CF" d="M372.4 397h24.8v154.5h-24.8z" clipPath="url(#b)"/>
  <g clipPath="url(#b)">
    <path fill="#FFF" d="M291.6 397l204-236H245.3c28.3 4.2 49.3 34.2 49.3 61.7v136" opacity=".1"/>
  </g>
</svg>          <h1>Contact me</h1>
        </section>
      </div>
    );
  }
